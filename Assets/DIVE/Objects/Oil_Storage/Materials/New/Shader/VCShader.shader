	...
	SubShader {
		...
		Pass {
			...
			void InitalizeSurfaceData(Varyings IN, out SurfaceData surfaceData){
				...
				half4 blendingColorAndVertColor = lerp(_BaseColor * IN.color, _BaseColor * IN.color * IN.color, _Nas);
				half4 diffuse = lerp(baseMap * blendingColorAndVertColor, blendingColorAndVertColor, _Blend);
			...
			half4 LitPassFragment(Varyings IN) : SV_Target {
				...
				// surfaceData.smoothness, surfaceData.emission, surfaceData.alpha, surfaceData.normalTS);
